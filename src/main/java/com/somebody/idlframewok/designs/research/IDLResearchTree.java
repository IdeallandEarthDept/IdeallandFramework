...
public class IDLResearchTree {
    ...
    public void onProduceComplete(EntityPlayer player, IDLResearchNode node)
    {
        ...
        CommonFunctions.SafeSendMsgToPlayer(player, "idlframewok.msg.produce_complete", node.pathIDLayer, Integer.toString(node.pathID1,2), stack.getDisplayName());
    }
...
//                            CommonFunctions.SafeSendMsgToPlayer(player, "idlframewok.msg.research_complete", node.pathIDLayer, Integer.toString(node.pathID1,2));
//                        }
