    ...
    public void onCreatureDied(final LivingDeathEvent ev) {
        ...
        if (ev.getEntityLiving() == this)
        {
            ...
            if (count > 0)
            {
                ...
                {
                    CommonFunctions.SendMsgToPlayerStyled((EntityPlayerMP) ev.getSource().getTrueSource(), "idlframewok.msg.boss_revive", TextFormatting.DARK_PURPLE);
                    CommonFunctions.SendMsgToPlayerStyled((EntityPlayerMP) ev.getSource().getTrueSource(), "idlframewok.msg.boss_revive2", TextFormatting.YELLOW);
                }
            }
        }
