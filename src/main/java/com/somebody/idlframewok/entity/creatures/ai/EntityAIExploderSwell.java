...
//copied from creeper
public class EntityAIExploderSwell extends EntityAIBase {
    /** The creeper that is swelling. */
    EntityExploderBase swellingCreeper;
    /** The creeper's attack target. This is used for the changing of the creeper's state. */
    EntityLivingBase creeperAttackTarget;

    public EntityAIExploderSwell(EntityExploderBase entitycreeperIn)
    {
