...
public class EntityStopDigger extends EntityModUnit implements ICustomFaction {
    public EntityStopDigger(World worldIn) {
        super(worldIn);
        setBuilding();
        setSize(2f, 2f);
    }
...
//        }
        ...
        if (units.size() > 0)
        {
            ...
            CommonFunctions.SafeSendMsgToPlayer(TextFormatting.RED, event.getPlayer(), MessageDef.MSG_DIG_STOPPED_BY_DAMPER, units.get(0).getPosition());
        }
    }
}
