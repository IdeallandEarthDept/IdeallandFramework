...
public class ModelModVex extends ModelBiped {
    ...
    public ModelModVex(float p_i47224_1_)
    {
    ...
    /**
     * Sets the models various rotationIn angles then renders the model.
     */
    ...
    /**
     * Sets the model's various rotationIn angles. For bipeds, par1 and par2 are used for animating the movement of arms
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        if (entityIn instanceof EntityCatharVex)
        {
            EntityCatharVex entityvex = (EntityCatharVex)entityIn;
