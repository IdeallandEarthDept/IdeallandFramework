...
import com.somebody.idlframewok.entity.creatures.moroon.EntityMoroonGhostArcher;
import com.somebody.idlframewok.init.ModCreativeTabsList;
import com.somebody.idlframewok.item.armor.*;
import com.somebody.idlframewok.item.armor.masks.ItemAirSphere;
...
import com.somebody.idlframewok.item.armor.masks.ItemMaskDouErDun;
import com.somebody.idlframewok.item.artifact.ItemDeathSword;
import com.somebody.idlframewok.item.artifact.ItemJadeSeal;
import com.somebody.idlframewok.item.consumables.*;
import com.somebody.idlframewok.item.consumables.food.*;
import com.somebody.idlframewok.item.consumables.keys.ItemFlameShard;
import com.somebody.idlframewok.item.consumables.keys.ItemIceShard;
import com.somebody.idlframewok.item.diagnostics.ItemDiagnosticParasite;
import com.somebody.idlframewok.item.dualline.ItemNotes;
import com.somebody.idlframewok.item.edicts.ItemBuildSimpleHouse;
import com.somebody.idlframewok.item.edicts.ItemKillAllMortal;
import com.somebody.idlframewok.item.fading.ItemFadingArmor;
import com.somebody.idlframewok.item.goblet.*;
import com.somebody.idlframewok.item.misc.GuaCasters.ItemGuaExtractorBase;
import com.somebody.idlframewok.item.misc.GuaCasters.ItemGuaWaterBucket;
import com.somebody.idlframewok.item.misc.*;
import com.somebody.idlframewok.item.misc.customized.ItemBiaoSword;
import com.somebody.idlframewok.item.misc.customized.ItemKouSword;
import com.somebody.idlframewok.item.misc.customized.ItemSaiSword;
import com.somebody.idlframewok.item.misc.drop.ItemDropFood;
import com.somebody.idlframewok.item.misc.drop.ItemDropHeart;
import com.somebody.idlframewok.item.misc.dungeon.ItemTrapAdder;
import com.somebody.idlframewok.item.misc.dungeon.ItemTrapSetter;
import com.somebody.idlframewok.item.misc.dungeon.ItemTrapToolBase;
import com.somebody.idlframewok.item.misc.saga.ItemMotherPraise;
import com.somebody.idlframewok.item.misc.whatnots.ItemBeatBox;
import com.somebody.idlframewok.item.skills.*;
import com.somebody.idlframewok.item.skills.arknights.ItemShenjiaGrandTeleport;
import com.somebody.idlframewok.item.skills.arknights.ItemShenjiaTeleport;
import com.somebody.idlframewok.item.skills.arknights.ItemSkillRuleOS;
import com.somebody.idlframewok.item.skills.arknights.ItemSkillTrueSL;
...
import com.somebody.idlframewok.item.skills.classfit.alterego.ItemAlteregoAttack;
import com.somebody.idlframewok.item.skills.classfit.alterego.ItemAlteregoDefend;
import com.somebody.idlframewok.item.skills.classfit.alterego.ItemAlteregoFollow;
import com.somebody.idlframewok.item.skills.classfit.alterego.ItemCoreAlterego;
import com.somebody.idlframewok.item.skills.combat.*;
import com.somebody.idlframewok.item.skills.eightfold_basic.ItemSkillArmorBoost;
import com.somebody.idlframewok.item.skills.eightfold_basic.ItemSkillHasteBoost;
import com.somebody.idlframewok.item.skills.eightfold_basic.ItemSkillLuckBoost;
import com.somebody.idlframewok.item.skills.eightfold_basic.ItemSkillWindWalk;
import com.somebody.idlframewok.item.skills.martial.ItemSkillGuaPalm;
import com.somebody.idlframewok.item.skills.martial.ItemSkillMartialAttack;
import com.somebody.idlframewok.item.tool.ItemHammerBase;
import com.somebody.idlframewok.item.tool.ItemPickaxeBase;
import com.somebody.idlframewok.item.weapon.*;
import com.somebody.idlframewok.item.weapon.staff.ItemHealStaff;
import com.somebody.idlframewok.util.MetaUtil;
import com.somebody.idlframewok.potion.ModPotions;
import com.somebody.idlframewok.item.misc.ItemAITerminal;
