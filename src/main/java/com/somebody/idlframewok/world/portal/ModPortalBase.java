package com.somebody.idlframewok.world.portal;
...
public class ModPortalBase extends Teleporter {
    BlockPortal PORTAL_BLOCK = Blocks.PORTAL;
    IBlockState FRAME_BLOCK = Blocks.QUARTZ_BLOCK.getDefaultState();

    public ModPortalBase(WorldServer worldIn) {
        super(worldIn);
    }
        ...
        for (int i8 = 0; i8 < 4; ++i8)
        {
            for (int l8 = 0; l8 < 4; ++l8)
            {
                for (int l9 = -1; l9 < 4; ++l9)
                {
                    ...
                    this.world.setBlockState(new BlockPos(l10, l11, k12), flag1 ? FRAME_BLOCK : iblockstate, 2);
                }
            }
