...
public class ModConfig {
    ...
    @Config.LangKey("configgui.idlframework.category.Menu0.GeneralConf")
...
//        @Config.LangKey("idlframework.conf.general.welcome")
//        @Config.Comment("The text shown when a player logs in. Can be a key or a string.")
//        public String WELCOME_MSG = "idlframework.msg.welcome";
    }

    @Config.LangKey("configgui.idlframework.category.Menu0.DebugConf")
    ...
    @Config.LangKey("configgui.idlframework.category.Menu0.SpawnConf")
