package com.somebody.idlframework.util.NBTStrDef;
...
public class IDLNBTDef {
	...
	public static final String NAME_OFF= "idlframework.shared.off";
	public static final String NAME_ON= "idlframework.shared.on";
	...
	//gua socket
	public static final String GUA_NO_FREE_SOCKET_DESC = "idlframework.gua_enhance_no_free.desc";
	public static final String GUA_FREE_SOCKET_DESC = "idlframework.gua_enhance_free.desc";
	public static final String GUA_TOTAL_SOCKET_DESC = "idlframework.gua_enhance_total.desc";
	public static final String GUA_N_A_DESC = "idlframework.gua_not_applicable.desc";
	...
	public static final String KILL_COUNT_DESC = "idlframework.kill_count.desc";
