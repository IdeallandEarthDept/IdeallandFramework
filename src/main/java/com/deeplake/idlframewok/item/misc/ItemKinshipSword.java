package com.deeplake.idlframewok.item.misc;

import com.deeplake.idlframewok.item.IGuaEnhance;
import com.deeplake.idlframewok.item.ItemSwordBase;
import com.deeplake.idlframewok.util.IDLGeneral;
import com.deeplake.idlframewok.util.IDLSkillNBT;
...
import static com.deeplake.idlframewok.util.CommonDef.TICK_PER_SECOND;
import static com.deeplake.idlframewok.util.IDLSkillNBT.GetGuaEnhance;
...
//    public com.deeplake.idlframewok.item.skills.martial.BuffTuple GetWaterBuff(ItemStack stack)
//    {
//        int water = GetGuaEnhance(stack, 2);
//        return new com.deeplake.idlframewok.item.skills.martial.BuffTuple(water / 4, TICK_PER_SECOND * water * 2);
//    }
//
//    public com.deeplake.idlframewok.item.skills.martial.BuffTuple GetMountainBuff(ItemStack stack)
//    {
//        int gua = GetGuaEnhance(stack, 4);
//        return new com.deeplake.idlframewok.item.skills.martial.BuffTuple(gua / 4, TICK_PER_SECOND * gua * 2);
//    }
//
