...
public class ItemGuaCasterBase extends ItemBase {
    public ItemGuaCasterBase(String name) {
        super(name);
    }

    public Item[] validItems = new Item[]{ModItems.GUA[0]};
    protected Block containedBlock = Blocks.FLOWING_WATER;
...
//
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if (ammo.isEmpty())
        {
            CommonFunctions.SafeSendMsgToPlayer(playerIn, getUnlocalizedName(itemstack) + ".msg.no_ammo");
