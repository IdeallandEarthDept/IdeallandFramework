...
import static com.deeplake.idealland.item.skills.ItemSkillBase.activateCoolDown;
...
public class ItemBiaoSword extends ItemSwordBase {
    ...
    public void onUpdate(ItemStack stack, World worldIn, Entity entityIn, int itemSlot, boolean isSelected) {
        ...
        EntityUtil.Faction factionWielder = EntityUtil.faction(playerIn);
        ...
        if (stage > 0)
        {
            if (!worldIn.isRemote && worldIn.getWorldTime() % TICK_PER_SECOND == 0)
            {
                ...
                for (EntityLivingBase living: entities
                    ...
                    if (EntityUtil.getAttitude(factionWielder, living) == EntityUtil.ATTITUDE.HATE)
                    {
