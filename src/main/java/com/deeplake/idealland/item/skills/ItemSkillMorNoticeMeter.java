...
import static com.deeplake.idealland.util.NBTStrDef.IDLNBTDef.MOR_INTEREST;
...
public class ItemSkillMorNoticeMeter extends ItemSkillBase {
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
        ...
        if (isStackReady(playerIn, stack))
        {
            ...
            {
                int period = ModConfig.SPAWN_CONF.INVASION_PERIOD;
                int readVal = Distort(IDLNBT.getPlayerIdeallandIntSafe(playerIn, MOR_INTEREST), GetError(stack));
                Idealland.Log(String.format("true val = %d", IDLNBT.getPlayerIdeallandIntSafe(playerIn, MOR_INTEREST)));
                CommonFunctions.SendMsgToPlayer((EntityPlayerMP) playerIn, "idealland.msg.notice_meter_report",
    ...
    public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
       ...
       tooltip.add(I18n.format("idealland.skill.shared.error_desc", GetError(stack)));
    }
}
