...
import static com.deeplake.idealland.blocks.Furnitures.BlockExtractionDoorTest.FACING;
...
public class TileEntityBuilderHouse extends TileEntityBuilderBase {
	...
	static
	{
		register("idealland:builder.builder_one", TileEntityBuilderHouse.class);
	}
}
